...
def get_car_lane(img, path):
    global blur_ksize
    if 'video' in path:
        roi_vtx = np.array([[(200, 680), (0, 1045),(1800, 1100), (1800, 685)]])
...
if __name__ == '__main__':
    # video_cap = cv2.VideoCapture(r"F:\项目相关材料视频\软件杯测试视频\video-01.avi")
    # ret, img = video_cap.read()
    img = cv2.imread("../Image/video1.jpg")
    ...
    #     i = i + 1
    left_min, right_min, left_lines, right_lines = get_car_lane(img, "video")
