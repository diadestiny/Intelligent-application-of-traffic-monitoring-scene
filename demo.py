...
class Detect(object):
    ...
    def video(self, path):
        global tmp_img,draw_car_line_flag
        self.Process.start()
        ...
        elif 'video-01' in self.opt.source:
            tmp_img = cv2.imread("./Image/video1.jpg")
        elif 'video-02' in self.opt.source:
            tmp_img = cv2.imread("./Image/video2.jpg")
        elif 'video-03' in self.opt.source:
            tmp_img = cv2.imread("./Image/video3.jpg")
        else:
            tmp_img = cv2.imread("./Image/video1.jpg")
            draw_car_line_flag = 0
        with torch.no_grad():
            first_index = True
